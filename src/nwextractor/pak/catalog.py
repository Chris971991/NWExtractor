...
ASSET_CATEGORIES: dict[str, tuple[str, str]] = {
    ...
    ".cgfheap": ("Models", "CGFHeap (Geometry Data)"),
    ".skin": ("Models", "SKIN (Skinned Mesh)"),
    ".chr": ("Models", "CHR (Character/Skeleton)"),
    ".cloth": ("Models", "Cloth Simulation"),
    # Characters
    ".cdf": ("Characters", "CDF (Character Definition)"),
    ".chrparams": ("Characters", "CHR Params (Anim Settings)"),
    # Animations
    ".caf": ("Animations", "CAF (Character Animation)"),
    ".anm": ("Animations", "ANM (Animation)"),
    ".i_caf": ("Animations", "I_CAF (Intermediate Anim)"),
    ".bspace": ("Animations", "Blend Space"),
    ".adb": ("Animations", "ADB (Animation Database)"),
    ".animevents": ("Animations", "Anim Events"),
    ".actionlist": ("Animations", "Action List"),
    ".comb": ("Animations", "Combination"),
    ".rnr": ("Animations", "RNR"),
    ".timeline": ("Animations", "Timeline"),
    # Materials
    ".mtl": ("Materials", "MTL (Material)"),
    ".material": ("Materials", "Material"),
    ".regionmat": ("Materials", "Region Material"),
    ".surfacemap": ("Materials", "Surface Map"),
    # Audio
    ".wem": ("Audio", "WEM (Wwise Audio)"),
    ".bnk": ("Audio", "BNK (Wwise Bank)"),
    ".ogg": ("Audio", "OGG"),
    ".wav": ("Audio", "WAV"),
    ".musicsheetc": ("Audio", "Music Sheet"),
    # Levels / Maps
    ".cry": ("Levels", "CRY (Level)"),
    ".lyr": ("Levels", "LYR (Layer)"),
    ".vegmap": ("Levels", "VEGMAP (Vegetation)"),
    ".entities_xml": ("Levels", "Entity Placements"),
    ".heightmap": ("Levels", "Heightmap"),
    ".vegetation": ("Levels", "Vegetation Data"),
    ".distribution": ("Levels", "Distribution Map"),
    ".waterqt": ("Levels", "Water Quadtree"),
    ".chunks": ("Levels", "Mesh Chunks"),
    # Game Data
    ".datasheet": ("Game Data", "Datasheet"),
    ".dynamicslice": ("Game Data", "Dynamic Slice"),
    ".aliasasset": ("Game Data", "Alias Asset"),
    ".grid": ("Game Data", "Grid Data"),
    ".vshapec": ("Game Data", "Vegetation Shape"),
    ".metadata": ("Game Data", "Metadata"),
    ".meta": ("Game Data", "Asset Meta"),
    ".dat": ("Game Data", "DAT"),
    ".ent": ("Game Data", "Entity Definition"),
    ".json": ("Game Data", "JSON"),
    ".xml": ("Game Data", "XML"),
    ".csv": ("Game Data", "CSV"),
    ".lua": ("Scripts", "LUA (Script)"),
    ".luac": ("Scripts", "LUAC (Compiled Script)"),
    ".txt": ("Game Data", "Text"),
    ".lst": ("Game Data", "List"),
    # Shaders
    ...
    ".cfxb": ("Shaders", "CFXB (Compiled FX)"),
    ".cfib": ("Shaders", "CFIB (Compiled Include)"),
    ".ext": ("Shaders", "Shader Extension"),
    # UI
    ".uicanvas": ("UI", "UI Canvas"),
    ".dynamicuicanvas": ("UI", "Dynamic UI Canvas"),
    ".sprite": ("UI", "Sprite"),
    ".font": ("UI", "Font"),
    ".fontfamily": ("UI", "Font Family"),
    # Navigation
    ".bai": ("Navigation", "AI Navigation"),
}
